<div class="col-md-6 col-lg-3" data-card-id="ordenesCierreVtex">
    <div class="card dashboard-card card-pending-close">
        <div class="card-header position-relative">
            <button type="button" class="btn-card-refresh" onclick="refreshCard('operaciones-sucursales', 'ordenesCierreVtex')" title="Actualizar"><i class="fas fa-sync-alt"></i></button>
            <i class="fas fa-hourglass-half card-icon"></i>
            <h5 class="card-title">
                Ordenes de Vtex Pendientes de Cierre
                <i class="fas fa-info-circle info-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Órdenes de Vtex pendientes de cierre"></i>
            </h5>
        </div>
        <div class="card-body">
