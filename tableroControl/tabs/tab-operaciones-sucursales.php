<!-- tabs/tab-operaciones-sucursales.php -->
<div class="d-flex justify-content-end mb-3">
    <button type="button" class="btn btn-outline-primary btn-sm" onclick="actualizarOperacionesSucursales()" id="btnActualizarOperacionesSucursales">
        <i class="fas fa-sync-alt me-2"></i>Actualizar Operaciones Sucursales
    </button>
</div>
<div class="row">
    <!-- PRIMERA FILA -->
    ...
    <!-- Card para Pedidos Recibidos pero no Entregados - Con Stock de Central -->
    <div class="col-md-6 col-lg-3">
...
<!-- SEGUNDA FILA -->
<div class="row mt-4">
    <!-- Pedidos Pendientes de Control Sucursales - Primera columna segunda fila -->
    <div class="col-md-6 col-lg-3">
    ...
    <!-- Pedidos Incompletos Sucursales - Segunda columna segunda fila -->
    <div class="col-md-6 col-lg-3">
        <div class="card dashboard-card card-incomplete">
            <div class="card-header">
                ...
                <h5 class="card-title">
                    ...
                    <?php if ($mostrarNuevoPedidosIncompletos): ?>
                        <span class="badge bg-success ms-1" style="font-size: 0.65rem;">NUEVO</span>
                    <?php endif; ?>
                    <i class="fas fa-info-circle info-icon" 
                    data-bs-toggle="tooltip" 
                    data-bs-placement="top" 
                    title="Pedidos con artículos faltantes en sucursales">
                    </i>
                </h5>
            </div>
            <div class="card-body">
