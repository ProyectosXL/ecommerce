...
<!-- Modal para el detalle de Pedidos Pendientes de Control -->
<div class="modal fade" id="modalPedidosPendientesControl" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center">
                <h5 class="modal-title">
                    <i class="fas fa-search"></i> Detalle de Pedidos Pendientes de Control
                </h5>
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-success" onclick="exportToExcelPedidosControl()">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="tablaPedidosControl">
                        ...
                        <tbody>
                            <?php 
                            $detallePedidosControl = $control->traerDetallePedidosPendientesControl();
