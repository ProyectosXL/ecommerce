...
<body>
    <div class="container email-container">
        ...
        <div class="email-subtitle">
            Su pedido <span class="order-number" id="orderNumber">#1515301341830-01</span> está listo para retirar
        </div>
        ...
        <div class="email-content">
            <div>
                <span style="max-width: 550px; display: inline-block;">
                    Su pedido ha llegado a nuestra sucursal! Corresponde a la compra realizada el día
        ...
        <div class="px-4 alert-section">
            ...
            <span style="color: #373535; font-size: 14px;">
                <div id="deliveryInstructions">
                    <ul>
                        <li>Tu pedido ha llegado a nuestra sucursal y ya está listo para retirar.</li>
                        ...
                        <strong><li>Tené en cuenta que: Deberá presentarse la persona que realizó la compra con DNI y la tarjeta con la que realizó la compra e informarle al asesor el n° de pedido</li></strong>
                    </ul>
                </div>
            </span>
        </div>
    ...
    <script src="js/htmlRetiroTienda.js"></script>
</body>
</html>